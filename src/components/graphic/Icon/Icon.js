...
Icon.propTypes = {
     ...
     * Size of icon
     */
    size: PropTypes.oneOf(["auto", "small", "medium", "large", "xLarge", "xxLarge"]),
    ...
    switch (name) {
        ...
        case "crop":
            return (
                ...
                >
                    <path d="M341.333 298.667H384V128c0-23.573-19.093-42.667-42.667-42.667H170.667V128h170.667v170.667z" />
                    <path d="M128 341.333V0H85.333v85.333H0V128h85.333v213.333C85.333 364.907 104.427 384 128 384h213.333v85.333H384V384h85.333v-42.667H128z" />
                </svg>
            );
        case "desktop":
            return (
        ...
        case "h1": {
            return (
                ...
                >
                    <path
                        fillRule="nonzero"
                        d="M0 14.309c.587-.03 1.003-.111 1.246-.247.408-.23.612-.663.612-1.3V2.116c0-.623-.182-1.045-.547-1.267C1.089.719.65.623 0 .559V0h7.444v.559C6.8.594 6.352.68 6.102.816c-.416.23-.623.663-.623 1.3v4.555h5.242V2.116c0-.637-.197-1.067-.591-1.289C9.886.691 9.432.602 8.766.56V0h7.487v.559c-.645.05-1.085.143-1.321.279-.394.222-.591.648-.591 1.278v10.646c0 .644.218 1.081.655 1.31.25.136.67.215 1.257.237v.558H8.766v-.558c.63-.022 1.077-.108 1.342-.258.409-.23.613-.66.613-1.29v-5.07H5.479v5.07c0 .652.222 1.093.666 1.322.257.129.69.204 1.3.226v.558H0v-.558Zm17.651.223c.711 0 1.167-.097 1.368-.29.2-.194.3-.562.3-1.104V7.744c0-.346-.04-.592-.12-.738-.079-.146-.226-.219-.44-.219-.114 0-.29.039-.527.116-.15.046-.355.119-.615.22v-.356l3.534-1.525h.246v7.978c0 .51.082.856.247 1.039.164.182.583.273 1.257.273v.335h-5.25v-.335Z"
                    />
                </svg>
            );
        }
        case "h2": {
            return (
                ...
                >
                    <path
                        fillRule="nonzero"
                        d="M.841 14.441c.588-.028 1.003-.11 1.246-.247.409-.229.613-.662.613-1.3V2.25c0-.623-.183-1.046-.548-1.268C1.93.853 1.493.756.842.691V.133h7.444V.69C7.64.727 7.194.813 6.943.95c-.415.23-.623.663-.623 1.3v4.555h5.242V2.249c0-.637-.197-1.067-.59-1.289-.244-.136-.699-.226-1.365-.269V.133h7.487V.69c-.644.05-1.085.144-1.321.28-.394.222-.59.648-.59 1.278v10.646c0 .644.218 1.08.654 1.31.251.136.67.215 1.257.236V15H9.607v-.559c.63-.021 1.078-.107 1.343-.257.408-.23.612-.66.612-1.29v-5.07H6.32v5.07c0 .652.222 1.093.666 1.322.258.129.69.204 1.3.225V15H.84v-.559Zm16.954.238c1.49-1.614 2.461-2.737 2.913-3.37.692-.957 1.039-1.805 1.039-2.543 0-.438-.134-.847-.4-1.227-.267-.381-.68-.571-1.241-.571-.492 0-.907.17-1.244.512a2.582 2.582 0 0 0-.486.752h-.382c.31-.97.738-1.69 1.285-2.156.547-.467 1.162-.701 1.846-.701.647 0 1.235.224 1.763.673.529.45.793 1.109.793 1.98 0 .455-.124.922-.372 1.4-.249.48-.667.999-1.255 1.56l-2.133 2.036v.117h1.99c.692 0 1.145-.057 1.357-.171.211-.114.425-.42.639-.916h.335L23.612 15h-5.817v-.321Z"
                    />
                </svg>
            );
        }
        case "h3": {
            return (
                ...
                >
                    <path
                        fillRule="nonzero"
                        d="M.841 14.441c.588-.028 1.003-.11 1.246-.247.409-.229.613-.662.613-1.3V2.25c0-.623-.183-1.046-.548-1.268C1.93.853 1.493.756.842.691V.133h7.444V.69C7.64.727 7.194.813 6.943.95c-.415.23-.623.663-.623 1.3v4.555h5.242V2.249c0-.637-.197-1.067-.59-1.289-.244-.136-.699-.226-1.365-.269V.133h7.487V.69c-.644.05-1.085.144-1.321.28-.394.222-.59.648-.59 1.278v10.646c0 .644.218 1.08.654 1.31.251.136.67.215 1.257.236V15H9.607v-.559c.63-.021 1.078-.107 1.343-.257.408-.23.612-.66.612-1.29v-5.07H6.32v5.07c0 .652.222 1.093.666 1.322.258.129.69.204 1.3.225V15H.84v-.559Zm17.85-1.314c.424 0 .86.229 1.309.687.449.458.82.687 1.11.687.502 0 .861-.17 1.078-.51.216-.339.324-.725.324-1.158 0-.798-.335-1.45-1.005-1.955-.382-.283-.989-.572-1.818-.868v-.226c.565-.196.968-.385 1.21-.567.415-.315.622-.74.622-1.279 0-.464-.14-.819-.42-1.063-.28-.243-.637-.365-1.07-.365-.401 0-.764.146-1.087.437-.182.164-.376.408-.581.732l-.294-.164c.219-.465.53-.88.936-1.244a3.282 3.282 0 0 1 2.27-.875c.597 0 1.116.168 1.558.505.443.338.686.777.732 1.32 0 .387-.086.732-.256 1.035-.171.303-.448.553-.831.749v.102c.56.224.97.56 1.23 1.009.26.449.39.921.39 1.418 0 1.003-.387 1.857-1.162 2.564-.807.742-1.827 1.114-3.062 1.114-.602 0-1.103-.114-1.504-.342-.401-.228-.602-.529-.602-.902 0-.2.072-.391.215-.571.144-.18.38-.27.708-.27Z"
                    />
                </svg>
            );
        }
        case "h4": {
            return (
                ...
                >
                    <path
                        fillRule="nonzero"
                        d="M.841 14.441c.588-.028 1.003-.11 1.246-.247.409-.229.613-.662.613-1.3V2.25c0-.623-.183-1.046-.548-1.268C1.93.853 1.493.756.842.691V.133h7.444V.69C7.64.727 7.194.813 6.943.95c-.415.23-.623.663-.623 1.3v4.555h5.242V2.249c0-.637-.197-1.067-.59-1.289-.244-.136-.699-.226-1.365-.269V.133h7.487V.69c-.644.05-1.085.144-1.321.28-.394.222-.59.648-.59 1.278v10.646c0 .644.218 1.08.654 1.31.251.136.67.215 1.257.236V15H9.607v-.559c.63-.021 1.078-.107 1.343-.257.408-.23.612-.66.612-1.29v-5.07H6.32v5.07c0 .652.222 1.093.666 1.322.258.129.69.204 1.3.225V15H.84v-.559Zm20.468-3.003V7.453h-.096L18.48 11.31v.13h2.83Zm-3.5-.034c.037-.077.075-.147.116-.208.041-.062.167-.24.376-.537l1.456-2.071 1.88-2.482.568-.731h1.114v6.063h.875v1.56h-.875V15h-2.024v-2.003H17.81v-1.593Z"
                    />
                </svg>
            );
        }
        ...
        case "lightning":
            return (
                ...
                >
                    <path
                        fillRule="nonzero"
                        d="M11.502 9.033 7.261 6.575l2.138-5.131A1.003 1.003 0 0 0 8.505 0a1.004 1.004 0 0 0-.692.274l-7.5 7.1a1.002 1.002 0 0 0 .185 1.592l4.242 2.46-2.163 5.19a.999.999 0 0 0 1.611 1.11l7.5-7.102a1.002 1.002 0 0 0-.186-1.591Z"
                    />
                </svg>
            );
        case "link":
        ...
        case "shopping-cart":
            return (
                <svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 512 512">
                    <path d="M18.1 12c-5.9 1.3-11.5 5.1-14.8 10.2C1 25.6.4 27.6.2 33.9c-.3 6.5 0 8.2 2.1 12.1 1.4 2.5 4.6 6 7.3 8l4.8 3.5 28.2.5c29.1.5 30.6.7 31.8 4.8.3 1 8.7 56.9 18.6 124.3 10.1 68.8 18.9 125.5 20 129.2 4.3 13.8 17.2 28.9 31 36.1 14.4 7.6 4.4 7.1 148.5 7.1 122.1 0 129.3-.1 135.5-1.8 20.5-5.8 38.7-22.8 44.6-41.5 2.9-9.4 39.4-193.7 39.4-199.2 0-10.7-7.4-19.6-18-21.9-3.6-.8-59-1.1-186-1.1H127.2l-.6-2.8c-.3-1.5-1.7-10.3-3.1-19.5-3.2-21.6-4-24.8-8.3-33-3.8-7.5-13.5-17.3-20.5-20.9-10.8-5.5-14.3-6-44.2-6.4-15.4-.1-30 .1-32.4.6zM171 381.5c-20.9 5.1-36.6 19.5-43.6 40-3.4 10.1-3.9 25.4-1 34.9 6.5 21.7 23.4 37.7 44.5 42.2 29.8 6.3 60.7-13 69.2-43.1 2.3-8.1 1.8-25.6-.9-33.7-9.7-29.3-40-47.2-68.2-40.3zM376.5 381c-21.5 4.6-39.4 20.3-45.6 39.9-2.6 8.3-3.6 23-2 31.3 4.2 21.7 22.1 40.6 43.9 46.3 7.7 2.1 22.2 2.1 30.2 0 17.1-4.4 31.4-16.1 38.8-31.5 4.7-10 6.2-16.3 6.2-26.8 0-25.4-16.2-47.9-40.8-56.9-7.4-2.8-23.3-4-30.7-2.3z" />
                </svg>
            );
        case "sign-out":
            return (
